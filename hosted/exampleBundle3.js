...
var FriendsContainer = /*#__PURE__*/function (_React$Component) {
  _inherits(FriendsContainer, _React$Component);

  var _super = _createSuper(FriendsContainer);
...
}(React.Component); //Function to 'Render' for our AddFriend React Component
...
var AddFriend = /*#__PURE__*/function (_React$Component2) {
  _inherits(AddFriend, _React$Component2);

  var _super2 = _createSuper(AddFriend);
  ...
  function AddFriend(props) {
    ...
    //constructor will accept attributes from the JSX that made it
    _this2 = _super2.call(this, props); //set our initial state. 
  ...
  **/
  ...
  return AddFriend;
}(React.Component); //Function to 'Render' for our ShowList React Component
...
var ShowList = /*#__PURE__*/function (_React$Component3) {
  _inherits(ShowList, _React$Component3);

  var _super3 = _createSuper(ShowList);
  ...
  return ShowList;
}(React.Component); //ReactDOM.render allows us to 'render' React classes/components
//to the page. 
